...
<body data-spy="scroll" data-target="#navbarscrolspy" data-offset="600">
    ...
    <nav class="navbar py-3 navbar-dark bg-dark fixed-bottom sticky-top" id="navbarscrolspy">      
    ...
    <div class="jumbotron mb-0 mt-n1 mb-n5" id="Register"
