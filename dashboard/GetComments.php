...
$PosterUsername = $getPost['username'];

$Query = $mysqli->query("SELECT Fname,Lname,avatarEXT FROM users where Email=(SELECT Email FROM profiles WHERE username='$PosterUsername');");
              ...
              <div class="tweetEntry pb-2 border-0">
                ...
                <div class="tweetEntry-content">
                  ...
                  <a class="tweetEntry-account-group" href="../members/?username=' . $PosterUsername . '">
                      <img class="tweetEntry-avatar" src="../Profile/Avatars/' . $PosterUsername  . '.' . $getPostOwner['avatarEXT'] . '">
                ...
                <div class="tweetEntry pb-2 border-0">
                  <div class="tweetEntry-content">
                        ...
                        <a class="tweetEntry-account-group" href="../members/?username=' . $ownerUsername . '">
                          <img class="tweetEntry-avatar" src="../Profile/Avatars/' . $ownerUsername . '.' . $getownerInfo['avatarEXT'] . '">
