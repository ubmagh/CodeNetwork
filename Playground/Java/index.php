        ...
        <div class="area mb-0 pb-3" style="background-image: url('../includes/bg1.jpg') !important;background-size: 100% 100% !important;background-repeat:none;height:990px; ">
            ...
            <div class="row  ml-2 mb-0 mt-n3">
                <div class="jumbotron col-7 mx-auto bg-transparent mt-n3 mb-n5">
                    <h1 class="display-4 text-center text-light ml-n1"><span class="letter" style="font-size: 58px;">Java Programming</span></h1>
            ...
            <?php
                if (isset($_GET['id'])) {
                    ...
                    if (empty($Code['id'])) {
                        echo 'File Not Found/DELETED !! ';
                    } else {

                        $file_path = "../../codes/" . $username . "/java/" . $Code['name'] . ".java";
                ...
                $(document).ready(function() {
                    ...
                    $('form').on('submit', function(e) {
                        ...
                        $.ajax({
                            ...
                            url: "java-compile.php", //destination
                        ...
                        if (name) {
                            ...
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    name: name,
                                    code: code
                                }, //target your form's data and serialize for a POST
