...
<body style="height:100%;overflow-y: hidden;">
    ...
    <div class="jumbotron mb-n3 mt-n1" id="Register" style="background-image: url('../images/bg2.jpg'); 
    background-repeat: no-repeat;background-size: cover;height: 900px;border-raduis:0px;">
        ...
        <nav class="navbar navbar-expand-sm navbar-dark bg-dark text-light py-0 mt-1 mb-n2 fixed-bottom">
            <ul class="navbar-nav mx-auto mt-3">
                <p> <a href="https://www.fb.com/SparoXUB" target="_blank" class="text-danger nav-link d-inline"> <span style="font-size:18px;font-family:Awsome;">CodeNetwok</span></a><span class="nav-link d-inline">©2019 All Rights Reserved</span> </p>
            </ul>
        </nav>
