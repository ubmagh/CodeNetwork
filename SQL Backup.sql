...
-- Database: `course`
--
CREATE DATABASE IF NOT EXISTS `course` DEFAULT CHARACTER SET latin1 COLLATE latin1_general_ci;
USE `course`;
...
(1, 'admin', 'anuj.lpu1@gmail.com', 'admin', '2016-04-04 20:31:45', '2016-04-17');
...
(8, '001', '001', '001', '2019-06-25 19:31:45');
...
(10, 1, 5, 100, 0, '2019-06-26', 12, '001', 1, 'Ayoub', '001', 'Maghdaoui', 'male', 696625030, 'ubmagh@gmail.com', 6966, 'dqsd', 'qsdqs', 0, 'ouled belaid', 'ouled berhil', 'Uttar Pradesh', 83300, 'dqs', 'dqsd', 'Jharkhand', 0, '2019-06-25 19:33:20', NULL);
...
(11, 21, 'ubmagh@gmail.com', 0x3a3a31, '', '', '2019-06-25 19:34:13');
...
(21, '001', 'Ayoub', '001', 'dfhdfh', 'male', 696625030, 'ubmagh@gmail.com', 'psd', '2019-06-25 19:33:20', '26-06-2019 01:04:42', NULL);
...
('root', '[{\"db\":\"network\",\"table\":\"users\"},{\"db\":\"network\",\"table\":\"apps_countries\"},{\"db\":\"network\",\"table\":\"admin\"},{\"db\":\"network\",\"table\":\"codes\"},{\"db\":\"network\",\"table\":\"comments\"},{\"db\":\"network\",\"table\":\"contact\"},{\"db\":\"network\",\"table\":\"description\"},{\"db\":\"network\",\"table\":\"follows\"},{\"db\":\"network\",\"table\":\"likes\"},{\"db\":\"network\",\"table\":\"posts\"}]');
...
('root', 'network', 'apps_countries', '{\"sorted_col\":\"`country_name` ASC\"}', '2019-11-09 19:44:00'),
('root', 'network', 'likes', '{\"sorted_col\":\"`PostID`  DESC\"}', '2019-11-09 17:49:07'),
('root', 'network', 'posts', '{\"sorted_col\":\"`postingDate` DESC\"}', '2019-11-09 17:48:14'),
('root', 'network', 'userlog', '{\"sorted_col\":\"`date` DESC\"}', '2019-10-21 18:43:28'),
('root', 'network', 'users', '[]', '2019-09-19 15:04:24');
...
('root', '2019-11-09 22:26:54', '{\"Console\\/Mode\":\"collapse\"}');
