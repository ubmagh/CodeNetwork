        ...
        <form action="" method="post">
                ...
                <div class="form-group mx-auto col-8 pb-3">
                    <input type="email"
                        ...
                        name="LogEmail" id="email" placeholder="Email Address" >
                </div>

                <div class="form-group mx-auto col-8 ">
                    <input type="Password"
                        class="form-control form_effect bg-dark text-center text-white border-top-0 border-left-0 border-right-0 "
                        name="LogPass" id="password" placeholder="Password" >
                </div>
...
////////
        if($isActivated){
            ...
            $log="insert into userlog(userId,userEmail,userIp,date) values('$uid','$uemail','$ip','$ldate')";
            $mysqli->query($log);
